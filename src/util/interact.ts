import { ShapeFileHeader, MapInteractor } from '../main.js';
import { updatePointGeometryRenderWebPage } from '../feature/point.js';
...
export function mapPanning(
    ...
    addEventMouseWheel(header, canvas, coordinates, mapInteractor);
}
